  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-16 text-center">
      ...
      <div className="mt-10 grid gap-6 text-left md:grid-cols-2">
        ...
        <div className="glass relative p-8 ring-1 ring-gold/50">
          <span className="absolute right-4 top-4 rounded-full bg-gold/15 px-2 py-0.5 text-xs font-bold text-gold">POPULAR</span>
          ...
          <button
            ...
            disabled={paid}
            className="mt-8 w-full rounded-xl bg-gold py-3 font-semibold text-black transition enabled:hover:brightness-110 disabled:opacity-50"
          >
